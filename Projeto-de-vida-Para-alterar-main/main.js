...
function calculaTempo(tempoObjetivo) {
    ...
    let segundos = Math.floor(tempoFinal / 1000);               //função para calcular o tempo
...
function comecaCronometro(){
    atualizaCronometro();
    setInterval(atualizaCronometro, 1000);     //espera a funcao de retorno
}

comecaCronometro();  //chamando o cronometro
